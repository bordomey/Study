...
num_spaces_in_tab = 2
input_file = "files/my_day.xml"
output_file = "files/my_day_1.yaml"
time_file = "files/check_time.txt"
...
def process_row(row: str, result: list[str], cur_spaces: int,
                spaces_tags: dict):
    row = row.strip()
